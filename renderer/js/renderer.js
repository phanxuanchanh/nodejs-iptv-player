...
if (channelItems !== undefined && channelItems !== null && channelItems.length > 0) {
...
if(videoEl !== undefined && videoEl !== null){
    ...
    const player = videojs('video', {
      ...
      // Bật menu chọn chất lượng
      player.updateSrc = function () {
          // plugin resolution-switcher tự detect levels
